...
- Все агенты (Architect, Coder, Reviewer, Explorer, Test Engineer, SME, Docs) обязаны писать все сообщения, отчеты, код-комментарии и документацию на русском языке
- Это правило распространяется на: сообщения в чате, вывод агентов, файлы документации, комментарии в коде
- Исключение: технические термины, имена переменных, названия функций и API остаются на английском
